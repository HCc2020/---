  ...
  <div class="home" :style="{backgroundImage:'url('+require('@/assets/home/bg.png')+')'}">
    ...
    <div class="page_bd">
      ...
      <div class="bd_center">
        ...
        <div class="map_box">
          <iframe class="myMap" src="http://smartwear.hoinnet.com/smartwear/login.html?account=jgdt&password=123456"
      ...
      <div class="bd_right">
        <div class="right-one" :style="{backgroundImage:'url('+require('@/assets/home/right-one.png')+')'}">
          ...
          <div class="organZH">
            ...
            <div class="item" @click="toPageZH('照护安全')">
              照护安全
            </div>
            <div class="item">
              照护服务
...
<script>
  ...
  export default {
    ...
    methods: {
      toPage() {
        window.open('http://www.yfcarecloud.com/cas/login?service=http://www.yfcarecloud.com/ecs-up-ws/cas&account=13605804976&rrr19950303=')
      },
      format(percentage) {
        return '';
      },
...
<style src="./InstitutionalPension.css" scoped>
</style>